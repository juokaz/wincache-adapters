...
class App_Cache_Backend_WinCache extends Zend_Cache_Backend implements Zend_Cache_Backend_ExtendedInterface
{
    /**
     * Log message
     */
    ...
    public function save($data, $id, $tags = array(), $specificLifetime = false)
    {
        ...
        $result = wincache_ucache_add($id, array($data, time(), $lifetime), $lifetime);
        if (count($tags) > 0) {
